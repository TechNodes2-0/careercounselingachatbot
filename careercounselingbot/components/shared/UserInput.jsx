...
const UserInput = ({ onMessageSubmit }) => {
  ...
  //       <input
  //         className="w-full px-3 py-2 mr-2 rounded-lg focus:outline-none focus:ring focus:border-blue-300"
  //         type="text"
  //         value={message}
  //         onChange={handleChange}
  //         placeholder="Type your message..."
  //       />
  //       <button className="px-4 py-2 text-white bg-blue-500 rounded-lg hover:bg-blue-600 focus:outline-none focus:bg-blue-600" type="submit">Send</button>
  //     </form>
  //   );
  return (
